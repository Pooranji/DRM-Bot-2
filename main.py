...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "WQa7KmF8")
    API_ID = int(os.environ.get("API_ID",  "66"))
    API_HASH = os.environ.get("API_HASH", "09ef3f42455")
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    SESSIONS = "./SESSIONS"

    AUTH_USERS = os.environ.get('AUTH_USERS', '611325').split(',')
